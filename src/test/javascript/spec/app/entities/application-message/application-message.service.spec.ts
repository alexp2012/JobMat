...
describe('Service Tests', () => {
  describe('ApplicationMessage Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a ApplicationMessage', () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            date: currentDate.format(DATE_TIME_FORMAT)
      ...
      it('should update a ApplicationMessage', () => {
        const returnedFromService = Object.assign(
          {
            text: 'BBBBBB',
            date: currentDate.format(DATE_TIME_FORMAT)
      ...
      it('should return a list of ApplicationMessage', () => {
        const returnedFromService = Object.assign(
          {
            text: 'BBBBBB',
            date: currentDate.format(DATE_TIME_FORMAT)
      ...
      it('should delete a ApplicationMessage', () => {
