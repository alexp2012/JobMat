...
import { ApplicationMessageComponent } from 'app/entities/application-message/application-message.component';
...
describe('Component Tests', () => {
  describe('ApplicationMessage Management Component', () => {
    let comp: ApplicationMessageComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ApplicationMessageComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new ApplicationMessage(123)],
            headers
          })
        )
      );
