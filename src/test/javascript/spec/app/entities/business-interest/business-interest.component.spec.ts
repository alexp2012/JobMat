...
import { BusinessInterestComponent } from 'app/entities/business-interest/business-interest.component';
...
describe('Component Tests', () => {
  describe('BusinessInterest Management Component', () => {
    let comp: BusinessInterestComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BusinessInterestComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.businessInterests[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
