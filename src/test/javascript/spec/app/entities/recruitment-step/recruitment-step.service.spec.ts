...
describe('Service Tests', () => {
  describe('RecruitmentStep Service', () => {
    let injector: TestBed;
    let service: RecruitmentStepService;
    let httpMock: HttpTestingController;
    let elemDefault: IRecruitmentStep;
    let expectedResult;
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(RecruitmentStepService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new RecruitmentStep(0, 'AAAAAAA', 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a RecruitmentStep', async () => {
        ...
        service
          .create(new RecruitmentStep(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
