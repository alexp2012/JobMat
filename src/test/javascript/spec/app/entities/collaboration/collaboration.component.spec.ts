...
import { CollaborationComponent } from 'app/entities/collaboration/collaboration.component';
...
describe('Component Tests', () => {
  describe('Collaboration Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.collaborations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
