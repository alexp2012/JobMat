...
import { OpeningComponent } from 'app/entities/opening/opening.component';
import { OpeningService } from 'app/entities/opening/opening.service';
import { Opening } from 'app/shared/model/opening.model';

describe('Component Tests', () => {
  describe('Opening Management Component', () => {
    let comp: OpeningComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(OpeningComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.openings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
