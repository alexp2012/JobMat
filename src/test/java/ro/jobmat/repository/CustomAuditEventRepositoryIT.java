...
import ro.jobmat.config.audit.AuditEventConverter;
import ro.jobmat.domain.PersistentAuditEvent;
...
import static ro.jobmat.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
