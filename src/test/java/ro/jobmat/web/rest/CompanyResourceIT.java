...
public class CompanyResourceIT {
    ...
    private static final CompanyType UPDATED_COMPANY_TYPE = CompanyType.CUSTOMER;
    ...
    private static final Instant SMALLER_JOIN_DATE = Instant.ofEpochMilli(-1L);
    ...
    public void createCompany() throws Exception {
        ...
        assertThat(testCompany.getCui()).isEqualTo(DEFAULT_CUI);
        assertThat(testCompany.getJoinDate()).isEqualTo(DEFAULT_JOIN_DATE);
    }
    ...
    @Test
    @Transactional
    public void checkCuiIsRequired() throws Exception {
        int databaseSizeBeforeTest = companyRepository.findAll().size();
        // set the field null
        company.setCui(null);
    ...
    public void getAllCompanies() throws Exception {
        ...
        restCompanyMockMvc.perform(get("/api/companies?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].cui").value(hasItem(DEFAULT_CUI.toString())))
    ...
    public void updateCompany() throws Exception {
        ...
        assertThat(testCompany.getCui()).isEqualTo(UPDATED_CUI);
        assertThat(testCompany.getJoinDate()).isEqualTo(UPDATED_JOIN_DATE);
    }
